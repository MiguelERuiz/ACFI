...
\begin{document}
  ...
  \section{Definiciones}
    \begin{frame}{Property-based Testing. Definición}
      ...
      \end{itemize}
      \todo{PBT tiene dos fases 1) generar datos de entrada de manera aleatoria 2) hacer verificaciones de las funciones aplicadas a esos datos  }
    \end{frame}
    ...
    \begin{frame}{Propiedades}
      ...
      \begin{itemize}
        ...
        dentro del código
      \end{itemize}
      \todo{Añadir en conclusiones: Merece la pena usar PBT porque te genera casos de test muy `rápido'}
      \todo{Añadir en conclusiones: Hay casos en los que puede merecer la pena más hacer test unitarios}
      \todo{Añadir en conclusiones: La realidad es que no se usa porque está muy centrado en lenguajes funcionales}
    \end{frame}
  \section{Erlang}
    \subsection{Historia}
    \begin{frame}{Erlang}
    ...
    \begin{frame}[fragile]{Sintaxis. Funciones de Orden Superior}
      \begin{minted}{erlang}
        ...
        [4,5,6]
      \end{minted}
      \todo{Poner un ejemplo de pattern matching}
    \end{frame}
    %%% Paso de mensajes??
  \section{PropEr}
    \begin{frame}{PropEr}
    ...
    \subsection{Propiedades con estado}
      \begin{frame}{PropEr. Propiedades con estado}
        \improvement{Qué ejemplo puedo poner aqui}
        \todo{Decir que hasta ahora hemos visto propiedades sin estado}
